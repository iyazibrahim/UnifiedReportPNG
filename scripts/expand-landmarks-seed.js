...
const QUERIES = [
  ...
  { category: "supermarket", ql: 'node["shop"="convenience"]["brand"]' },
  { category: "landmark", ql: 'node["amenity"="fuel"]["name"]' },
  { category: "landmark", ql: 'way["amenity"="fuel"]["name"]' },
  { category: "landmark", ql: 'node["amenity"="fuel"]["brand"]' },
